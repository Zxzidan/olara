...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white border border-[#DDE3DF] rounded-3xl p-6 shadow-sm space-y-2">
            ...
            <span class="text-[11px] text-[#168A5B] font-bold">
                Mencegah penebangan kayu hutan
            </span>
        </div>
        ...
        <div class="bg-white border border-[#DDE3DF] rounded-3xl p-6 shadow-sm space-y-2">
            ...
            <div class="flex items-baseline gap-1.5">
                <h3 class="text-2xl sm:text-3xl font-extrabold text-[#0B4F38] tabular-nums">{{ number_format($waterSavedLiters) }}</h3>
                <span class="text-sm font-bold text-gray-500">Liter</span>
            </div>
            <span class="text-[11px] text-gray-500 font-medium">
                Hemat {{ $energySavedKwh }} kWh daya listrik
            </span>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div class="lg:col-span-7 bg-white border border-[#DDE3DF] rounded-3xl p-6 shadow-sm space-y-4">
            <div class="flex items-center justify-between border-b border-gray-100 pb-3">
                ...
                <span class="text-xs font-bold text-[#168A5B] bg-[#EEF9F2] px-2.5 py-1 rounded-lg">
        ...
        <div class="lg:col-span-5 bg-white border border-[#DDE3DF] rounded-3xl p-6 shadow-sm space-y-6">

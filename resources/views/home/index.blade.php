...
<div class="space-y-5">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-stone-800/95 p-5 sm:p-6 rounded-2xl border border-stone-200/80 dark:border-stone-700/80 shadow-soft">
        <div>
            <div class="flex items-center gap-2.5 flex-wrap">
                ...
                <span class="inline-flex items-center gap-1.5 bg-[#FFE4E1] text-[#a7322b] dark:bg-stone-700 dark:text-[#ffb7b2] text-xs font-bold px-3 py-0.5 rounded-full">
                    <i data-lucide="award" class="w-3.5 h-3.5"></i> {{ $tierName }}
                </span>
                @if($user && $user->membership_tier === 'premium')
                    <span class="inline-flex items-center gap-1.5 bg-amber-100 text-amber-800 dark:bg-amber-900/60 dark:text-amber-200 text-xs font-bold px-3 py-0.5 rounded-full">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white dark:bg-stone-800/95 p-5 rounded-2xl border border-stone-200/80 dark:border-stone-700/80 shadow-soft hover:shadow-md transition-all group">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-[11px] font-semibold text-stone-500 dark:text-stone-400 uppercase tracking-wider">Saldo Poin</p>
                    <h3 class="font-outfit text-2xl sm:text-3xl font-extrabold text-stone-900 dark:text-white mt-1 tabular-nums">
            ...
            <div class="mt-3.5 flex items-center justify-between text-xs pt-2.5 border-t border-stone-100 dark:border-stone-700/60">
        ...
        <div class="bg-white dark:bg-stone-800/95 p-5 rounded-2xl border border-stone-200/80 dark:border-stone-700/80 shadow-soft hover:shadow-md transition-all group">
            ...
            <div class="mt-3.5 flex items-center justify-between text-xs pt-2.5 border-t border-stone-100 dark:border-stone-700/60">
                <span class="text-[#168A5B] dark:text-emerald-400 font-medium">Bebas dari TPA</span>
    ...
    <div class="bg-white dark:bg-stone-800/95 p-5 sm:p-6 rounded-2xl border border-stone-200/80 dark:border-stone-700/80 shadow-soft">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
            <!-- Left: Level Progress -->
            <div class="lg:col-span-7 space-y-2.5">
                <div class="flex items-center justify-between text-xs font-semibold">
                    <span class="text-stone-700 dark:text-stone-300">
                        Tingkat Recycler: <strong class="text-[#cb3930] dark:text-[#ffb7b2] font-bold">{{ $tierName }}</strong>
                    </span>
                    <span class="text-stone-500 dark:text-stone-400">
                        Target: <strong class="text-stone-900 dark:text-white">{{ $nextTierName }}</strong> ({{ number_format($pointsRemaining) }} poin lagi)
                    </span>
                </div>
                ...
                <p class="text-[11px] text-stone-500 dark:text-stone-400">
                    Scan sampah (+10 Pts) atau setor ke mitra untuk naik level berikutnya.
                </p>
            </div>

            <!-- Right: Fast Shortcut Pills -->
            <div class="lg:col-span-5 grid grid-cols-3 gap-2.5">
                <a href="{{ route('scanner.index') }}" class="flex flex-col items-center justify-center p-3 rounded-xl border border-stone-200/80 dark:border-stone-700 hover:bg-stone-50 dark:hover:bg-stone-700/70 text-center transition group shadow-2xs active:scale-[0.98]">
                ...
                <a href="{{ route('pickup.index') }}" class="flex flex-col items-center justify-center p-3 rounded-xl border border-stone-200/80 dark:border-stone-700 hover:bg-stone-50 dark:hover:bg-stone-700/70 text-center transition group shadow-2xs active:scale-[0.98]">
                ...
                <a href="{{ route('dropoff.index') }}" class="flex flex-col items-center justify-center p-3 rounded-xl border border-stone-200/80 dark:border-stone-700 hover:bg-stone-50 dark:hover:bg-stone-700/70 text-center transition group shadow-2xs active:scale-[0.98]">
    ...
    @if($activePickup)
        <div class="bg-[#FFE4E1]/30 dark:bg-stone-800/95 border border-[#FFB7B2]/50 dark:border-stone-700 p-4 sm:p-5 rounded-2xl shadow-soft flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div class="flex items-center gap-3.5">
                <div class="w-10 h-10 rounded-full bg-[#FFB7B2] text-[#292524] flex items-center justify-center shrink-0 shadow-xs">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="bg-white dark:bg-stone-800/95 p-5 sm:p-6 rounded-2xl border border-stone-200/80 dark:border-stone-700/80 shadow-soft">
            <div class="flex items-center justify-between mb-4 pb-3 border-b border-stone-100 dark:border-stone-700/60">
                <div class="flex items-center gap-2">
            ...
            @if($recentAnalysis->isEmpty())
                <div class="text-center py-8 text-stone-400 dark:text-stone-500 text-xs">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2 text-[11px] text-stone-500 dark:text-stone-400 mt-0.5">
                                        ...
                                        <span>•</span>
                                        <span class="text-[#168A5B] dark:text-emerald-400 font-semibold">Akurasi {{ $analysis->confidence_rate }}%</span>
                                        <span>•</span>

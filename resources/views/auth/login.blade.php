                    ...
                    <div>
                        <div class="relative">
                            <input 
                                ...
                                class="w-full pl-4 pr-11 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 text-sm placeholder-gray-400 focus:bg-white focus:outline-none focus:border-[#10b981] focus:ring-2 focus:ring-[#10b981]/20 transition"
                            />
                            <button 
                                type="button" 
                                onclick="togglePasswordVisibility('password', 'loginEye', 'loginEyeOff')"
                                class="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 focus:outline-none cursor-pointer flex items-center justify-center p-1"
                            ...
                            >
                                ...
                                <svg id="loginEyeOff" class="w-5 h-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
